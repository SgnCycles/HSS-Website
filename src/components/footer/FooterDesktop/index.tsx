    ...
    <footer>
      ...
      <div className="bg-blue-900 flex justify-between pt-25 px-10 pb-10 gap-5">
        <div className="flex flex-col w-[25%] justify-between">
          <h3 className="font-heading text-yellow-500 font-bold text-[26px]">Våra lokaler</h3>
        ...
        <div className="flex flex-col justify-between w-[60%]">
          <div className="text-center px-4">
            <h3 className="font-heading text-yellow-500 font-extrabold text-[32px]">Hässelby Strands Sjöscoutkår</h3>
            <p className="font-body text-grey-300 text-[24px]">En stolt del av Scouterna sedan 1959.<br></br>
              Vi ger barn och ungdomar äventyr, sjömanskap och <br></br> gemenskap vid Hässelby Strand.</p>
          </div>
          <div className="flex justify-center p-4">
            <Image src="/images/Logo/scouterna_logo_white.png" height={54} width={279} alt="ScouternaLogoImage"></Image>
          </div>
          <div className="flex flex-col items-center text-yellow-500 text-[24px]">
