  ...
  return (
    <>
      <article className="flex flex-col items-center">
        <div className="flex flex-row items-center pb-2.5 gap-2.5">
        ...
        <div className="flex gap-2 pl-2 pr-2 justify-center rounded-md w-fit border bg-secondary border-accent mb-2.5">
      ...
      <article className="flex flex-col bg-yellow-200">
        <h2 className="font-heading text-[20px] font-semibold text-blue-900">Se andra dokument</h2>
        <Link target="_blank" href="" className="font-body">Stadgar för Hässelby Strands Sjöscoutkår →</Link>
        <Link target="_blank" href="" className="font-body">Verksamhetsplan för perioden 2025-2026 →</Link>
        <Link target="_blank" href="" className="font-body">HSS Kår stämma för 2025 →</Link>
      </article>
      <article>
