...
const ActivityFeature = () => {
  ...
  return(
    <article className="relative mt-6 mb-6 md:w-[80%] lg:w-[70%] mx-auto">
      <section className="text-center md:flex ">
        <div className="flex gap-2 p-1 justify-center">
          <Image className="w-5 h-auto md:w-7.5" src={activityFeatureContent.icon} alt="" width={20} height={20} />
        ...
        {!isHomePage && (
          <Image className="hidden absolute -z-10 -right-35 -top-25 h-auto w-75 md:block" src={"/images/Backgrounds/boatBackground1.png"} alt="Boat" height={1000} width={1000} />
        )}
      </section>
      ...
      <section className="mt-4 xl:max-h-125 md:flex">
        <ActivityCard />
        {!isHomePage && (
