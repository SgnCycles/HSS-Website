      ...
      <div className="">
        <div className="text-center lg:flex ">
          <div className="flex gap-2 p-1 justify-center">
            ...
            <h2 className="heading-3 font-heading font-extrabold text-primary md:text-[40px] lg:text-4xl">{t('titleKey')}</h2>
          </div>
        ...
        <p className="hidden paragraph mt-6 mb-6 text-[20px] lg:block">{t('infoDescFirstKey')}</p>
        <p className="hidden paragraph mt-6 mb-6 text-[20px] lg:block">{t('infoDescSecondKey')}</p>
        <div className="mt-4 xl:max-h-125 lg:flex">
          <ActivityCard />
          {!isHomePage && (
            <p className="text-base paragraph font-normal m-4 font-body lg:hidden">{t('infoKey')}</p>
          )}
