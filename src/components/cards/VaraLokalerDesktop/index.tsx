      ...
      <article className="container flex gap-5 items-center">
        ...
        <div className="h-145.5 w-[75%]">
          <Image
            ...
            width={400}
            alt="Myset"
            className="h-145.5 w-180.75 rounded-md object-cover"
          />
        </div>
      </article>
      <article>
        <div className="container flex flex-col justify-center">
          ...
          <button
            onClick={handleClick}
            className="paragraph-light underline underline-offset-2 text-blue-900 cursor-pointer"
          >
            {t("bookingDetail3")}
          </button>
          {isOpen && (
            <div className="fixed w-full h-full z-50 top-0 left-0 flex items-center justify-center">
              ...
              <article className="bg-background p-6 z-10 w-[80%]">
                <Image
                  src="/images/Body/myset_plan.png"
                  height={1000}
                  width={1000}
                  alt="Planlösning av Myset"
          ...
          <div className="mt-20 self-center">
            <Image
              ...
              width={1260}
              alt="våra lokaler"
              className="object-cover w-auto rounded-md h-auto"
            />
          </div>
        </div>
      </article>
