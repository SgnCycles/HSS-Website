...
export default function Hero({ img, isHome }: HeroProps) {
  return (
    <div
      className={`bg-cover relative bg-no-repeat w-full ${isHome === "true" ? "h-[288px] md:h-screen flex items-center justify-center" : "h-[144px] md:h-[374px] flex items-center justify-center"}`}
      style={{
          ...
          >
            <p>
              <span className="block font-bold font-body text-background">
                Vi är en stolt sjöscoutkår som ger barn och ungdomar en trygg
                plats
              </span>
              <span className="block font-bold font-body text-background">
