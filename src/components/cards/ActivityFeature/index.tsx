    ...
    <article className="font-body container">
      <div className="">
        ...
        <div className="mt-4 xl:max-h-125 lg:flex section">
          ...
          <Image className="h-auto w-full mt-6 object-cover object-top lg:rounded-md lg:border lg:border-accent lg:mt-0" src={"/images/Body/home_body1.png"} alt="" height={1000} width={1000} />
          {isHomePage && (
