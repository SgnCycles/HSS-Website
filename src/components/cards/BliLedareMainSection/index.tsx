      ...
      {!isOpen && (
        <article className="container">
          <div className="flex w-full justify-center lg:justify-start items-center pb-6">
            ...
            <h1 className="heading-1">{t("heading1")}<span className="hidden sm:inline-block">{t("heading2")}</span>
            </h1>
          </div>
          ...
          <p className="text-base font-bold text-center text-primary text-extrabold lg:hidden">{t('details.p6')}</p>
        </article>
      )}
      {isOpen && (
