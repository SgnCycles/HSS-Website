...
const VilkaArViPage = () => {
  return (
    <>
      <article className="flex flex-col items-center font-body">
      ...
      <article className="flex flex-col bg-yellow-200 p-5 font-body">
      ...
      <article className="font-body">
        <div className="flex flex-row items-center p-5 gap-2.5 pb-0">
          <Image className="absolute -z-10 top-405 right-0" src={"/images/Backgrounds/boatBackground1.png"} alt="Boat" height={119} width={175} />
