    ...
    <section className="block lg:hidden md:flex md:flex-col">
      <article className="container flex flex-col justify-center pb-0">
        ...
        <div className="w-screen mt-5 self-center">
          <Image
            src="/images/Body/varaLokaler_body1.png"
            height={324}
            width={400}
            alt="Myset"
            className="h-auto md:w-[-webkit-fill-available] w-[-webkit-fill-available]"
          />
        </div>
      </article>
      ...
      <article>
        <div className="container">
          <div className="flex">
            <Image
              className="h3-icon"
              src="/Icons/egg-cooking-icon.svg"
              height={30}
              width={30}
              alt=""
            />
      ...
      <article>
        <div className="container flex flex-col justify-center">
          ...
          <a
            target="_blank"
            href="/pdf/myset_plan.pdf"
            className="paragraph-light underline underline-offset-2 text-blue-900"
          >
            {t("bookingDetail3")}
          </a>
          <Button
          ...
          <div className="w-screen mt-5 self-center">
            <Image
              src="/images/Body/varaLokaler_body2.png"
              height={324}
              width={400}
              alt="Våra lokaler"
              className="object-cover h-60 md:w-[-webkit-fill-available] w-[-webkit-fill-available]"
            />
          </div>
        </div>
      </article>
      ...
      <article>
        <div className="w-screen">
          <Image
            src="/images/Body/varaLokaler_body3.png"
            height={324}
            width={400}
            alt="Ruffen"
            className="h-auto md:w-[-webkit-fill-available] w-[-webkit-fill-available]"
