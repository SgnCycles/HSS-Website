...
const AretiHssPage = () => {
  return (
    <main id="main-content" className="bg-background bg-contain bg-no-repeat lg:bg-[url(/images/Backgrounds/blueWavyBoat2.png)] lg:bg-size-[100%] lg:bg-no-repeat lg:bg-top">
