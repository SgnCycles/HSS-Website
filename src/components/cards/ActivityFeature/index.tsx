...
const ActivityFeature = () => {
  ...
  const isHomePage =
    pathname === "/" || pathname === "/sv" || pathname === "/en";
    ...
    <div>
      <article className="font-body container">
        <div>
          ...
          <p className="hidden paragraph-light lg:block">
            {t("infoDescFirstKey")}
          </p>
          <p className="hidden paragraph-light lg:block">
            {t("infoDescSecondKey")}
          ...
          <div className="mt-4 lg:flex section">
            ...
            <Image
              className="hidden h-auto w-full object-cover object-top mt-6 lg:mt-0 md:block lg:max-w-87.5 rounded-md border border-accent"
      ...
      <Image
        className="h-auto pb-0 w-full card pl-0 pr-0 pt-0 rounded-none object-cover object-top lg:rounded-md lg:border lg:border-accent lg:mt-0 md:hidden"
        src="/images/Body/home_body1.png"
        alt=""
        height={1000}
        width={1000}
