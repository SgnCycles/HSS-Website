...
const BliLedareHome = () => {
  return (
    ...
    <article className="bg-primary font-body text-background pt-6 pb-6 md:grid md:place-items-center md:pt-20 md:pb-20">
      <div className="md:grid md:place-items-center w-full">
        <div className="flex w-full justify-center items-center">
          <Image
            ...
            alt=""
          />
          <h2 className="font-heading text-[22px] md:text-[40px] font-extrabold pl-2 md:text-5xl text-nowrap">
            <span className="text-accent">Bli ledare - </span>vi utbildar dig!
          </h2>
        </div>
        <div className="flex flex-col items-center">
          <p className="text-muted text-base md:text-xl pt-4 pb-4 w-[90%] text-center">
            Du behöver inga förkunskaper. Vi skickar dig på Scouternas
            ledarutbildning och du får stöd av erfarna ledare från dag ett.
          </p>
          <div className="flex flex-col justify-between md:flex-row w-[90%] lg:w-[70%]">
            <ul className="flex flex-col gap-6 md:gap-4 pb-6 md:pb-0">
