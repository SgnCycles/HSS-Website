...
const AretiHssPage = () => {
  return (
    <main id="main-content">
      <section className="full-bleed flex flex-col lg:bg-[url(/images/Backgrounds/blueWavyBoat5.png)] lg:bg-size-[100%] lg:bg-no-repeat lg:bg-top bg-[url(/images/Backgrounds/boatBackground1.png)] bg-size-[175px] bg-no-repeat bg-right">
