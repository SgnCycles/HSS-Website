...
export default function Button({ ariaLabel, href, theme, text }: ButtonProps) {
  const themeClasses = {
  ...
  return ( 
    <Link 
      className={` ${themeClasses[theme]} text-center px-[64px] w-full sm:w-max transition-all duration-300 border-2 inline-flex items-center justify-center rounded-sm py-2 min-h-[70px]`}
      href={href}
